...
js_file_name = 'database_operations.js'
with open(js_file_name, 'w') as js_file:
    
    js_file.write(js_code)

# Execute the JavaScript file using subprocess
try:
    print("we made it here")
    result = subprocess.run(['node', js_file_name], check=True, capture_output=True, text=True)
    print(result.stdout)  # Print stdout from the JavaScript execution
    # print("we made it here")
except subprocess.CalledProcessError as e:
    print(f"Error executing JavaScript: {e.stderr}")
